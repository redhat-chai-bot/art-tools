...
class BuildMicroShiftPipeline:
    ...
    async def create_microshift_advisory(self) -> int:
        ...
        try:
            created_advisory = await errata_api.create_advisory(
                ...
                advisory_package_owner_email=get_package_owner(self.runtime.config['advisory'], self.group),
    ...
    async def _trigger_microshift_sync(self):
        ...
        try:
            ...
            message = (
                f"Please start <{constants.JENKINS_UI_URL}"
    ...
    async def _trigger_build_microshift_bootc(self):
        ...
        try:
            jenkins.start_build_microshift_bootc(
                ...
                doozer_data_gitref=self.data_gitref or None,
            )
            message = (
    ...
    async def _notify_microshift_alerts(self, version_release: str):
        ...
        message += "\nReach out in #forum-ocp-art if you need help."
